function [training_tng,test_tng,training_mad,test_mad,ga_ind,aden_ind,maden]=feature_selection_gaden(training,group,testing,limits,bottleneck,offspring,generations)


%--------------------------------------------------------------------------
 % FEATURE_SELECTION_GADEN
 ...
 % Usage:
 % [training_tng,test_tng,training_mad,test_mad,ga_ind,aden_ind,maden]=feature_selection_gaden(training,group,testing,limits,bottleneck,offspring,generations)
